...
import { HomeIcon, ChartIcon } from "../assets/icons"; // Asegúrate de la ruta

export default function PropertyDetailsModal({ property, isOpen, onClose, onNavigateToSimulator }) {
                    ...
                    <div className="lg:w-[400px]">
                        <div className="bg-white p-6 rounded-3xl shadow-[0_10px_40px_rgba(0,0,0,0.1)] border border-gray-100 sticky top-6">
                            ...
                            <div className="space-y-4">
                                ...
                                <button className="w-full bg-white border-2 border-gray-200 hover:border-gray-800 text-gray-800 py-4 rounded-xl text-lg font-bold transition-colors flex items-center justify-center gap-2">
                            ...
                            <div className="mt-6 pt-6 border-t border-gray-100">
                                <div className="flex items-center gap-4">
                                    <div className="w-12 h-12 bg-gray-200 rounded-full overflow-hidden">
                                        <img src="https://i.pravatar.cc/150?img=11" alt="Agente" className="w-full h-full object-cover" />
                                    </div>
                                    <div>
...
// --- Iconos Internos para no romper nada ---
